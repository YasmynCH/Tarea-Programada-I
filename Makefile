...
test:
	...
	g++ $(FLAGS) src/envioTipo2.cpp -o bin/envioTipo2.o
	g++ $(FLAGS) src/tipoEnvio.cpp -o bin/tipoEnvio.o
	g++ -g -o bin/tests bin/test_envioTipo1_calculoEnvio.o bin/test_envioTipo2_calculoEnvio.o bin/envioTipo2.o bin/envioTipo1.o bin/tipoEnvio.o -lgtest -lgtest_main -lpthread
